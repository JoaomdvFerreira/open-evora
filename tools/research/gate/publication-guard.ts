/**
 * LOW-3 deterministic publication guard (Human Gate contract §12,
 * independent-review finding LOW-3). Enforced at the Git-publication
 * boundary itself, immediately
