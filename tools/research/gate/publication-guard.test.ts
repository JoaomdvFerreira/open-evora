/**
 * LOW-3 deterministic publication guard adversarial tests (Human Gate
 * contract §12, independent-review finding LOW-3; failure-state coverage:
 * "LOW-3 unexpected path"). These
