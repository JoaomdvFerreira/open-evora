...
export const ContentStress: Story = { args: { entries: [{ ...entries[0], problemId: "PRB-XXXX", problemTitle: "Um problema com um título muito extenso para verificar a hierarquia entre a leitura humana e o identificador técnico", summary: "Uma descrição longa de alteração material confirma que a linha mantém uma leitura clara quando a explicação exige várias linhas, sem perder a data, o problema a que se refere ou a ação disponível." }], onExploreProblem: () => {} }, render: (args) => <div style={{ width: 360, maxWidth: "100%" }}><MaterialChangeTimeline {...args} /></div> };
