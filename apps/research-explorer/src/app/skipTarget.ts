 ...
 * loading/error branches supply their own element with this id too, since
 * ExplorerHeader isn't mounted in those states; TrustPage places it on its
 * article, after the global header and the local Information navigation.
 *
