...
function HeaderStory(props: Omit<ProblemIdentityHeaderProps, "headingRef">) {
  ...
  return <div style={{ maxWidth: 900, padding: 24 }}><ProblemIdentityHeader {...props} headingRef={headingRef} /></div>;
}
...
export const CompactWidth: Story = { render: () => <div style={{ width: 360, maxWidth: "100%" }}><HeaderStory {...base} /></div> };
